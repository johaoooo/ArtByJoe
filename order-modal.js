...
(function () {
  ...
  const i18n = {
    fr: {
      ...
      hero_btn1:    'Découvrir mes créations',
      hero_btn2:    'En savoir plus',
      scroll_lbl:   'Défiler',

      // Galerie
      gallery_tag:  'Portfolio',
      gallery_title:'Mes <span class="highlight-text">Créations</span>',
      gallery_desc: 'Les vraies créations de Joseph — 100% faites main à Porto-Novo & Calavi, Bénin.',
      filter_all:   'Tout',
      filter_pixel: '🎨 Pixel Macramé',
      filter_bag:   '👜 Sacs',
      filter_shoes: '👡 Sandales',
      gallery_cta:  'Commander une création personnalisée',
      cat_pixel:    'Pixel Macramé',
      cat_bag:      'Sacs Macramé',
      cat_shoes:    'Sandales Macramé',

      // Boutique
      shop_tag:     'Boutique',
      shop_title:   'Nos <span class="highlight-text">Produits</span>',
      shop_desc:    'Commandez directement vos créations préférées — livraison à Porto-Novo et Calavi.',
      btn_order:    'Commander',

      // Stats
      stat_years:   'Ans de passion',
      stat_creations:'Créations uniques',
      stat_handmade: 'Fait à la main',
      stat_cities:   'Villes au Bénin',

      // À propos
      about_tag:    'Mon Histoire',
      about_title:  "À Propos<br>d'<span class=\"highlight-text\">Art by Joe</span>",
      ...
      feat1_title:  'Fait Main',
      feat1_desc:   'Chaque pièce est unique',
      feat2_title:  'Matériaux Naturels',
      feat2_desc:   'Fils de qualité premium',
      feat3_title:  'Livraison Soignée',
      feat3_desc:   'Porto-Novo & Calavi',

      // Contact
      contact_tag:  'Restons en Contact',
      contact_title:'Parlons de <span class="highlight-text">Votre Projet</span>',
      contact_desc: "Vous avez une idée de création personnalisée ? N'hésitez pas — je suis disponible et réactif !",
      lbl_name:     'Votre nom *',
      lbl_email:    'Votre email *',
      lbl_subject:  'Sujet',
      lbl_message:  'Votre message *',
      ph_name:      'Joseph Dupont',
      ph_email:     'vous@exemple.com',
      ph_subject:   'Commande personnalisée',
      ph_message:   'Décrivez votre projet...',
      btn_send:     'Envoyer le message',
      success_title:'Message envoyé !',
      success_msg:  'Merci ! Joseph vous répond très vite.',
      ...
      svc1: 'Commandes personnalisées',
      svc2: 'Sandales macramé',
      svc3: 'Sacs macramé',
      svc4: 'Pixel macramé',
      footer_copy:  '© 2025 Art by Joe · Tous droits réservés · Fait avec ❤ au Bénin 🇧🇯',

      // Modal commande
      modal_title:  'Passer une commande',
      modal_lbl_name:  'Votre nom complet *',
      modal_lbl_phone: 'Votre téléphone *',
      modal_lbl_city:  'Votre ville *',
      modal_lbl_note:  'Note (taille, couleur…)',
      modal_lbl_momo:  'N° MoMo pour le paiement *',
      modal_ph_name:   'Ex: Awa Mensah',
      modal_ph_phone:  'Ex: +229 97 00 00 00',
      modal_ph_city:   'Ex: Porto-Novo',
      modal_ph_note:   'Ex: Taille 39, couleur rouge',
      modal_ph_momo:   'Votre numéro MTN MoMo',
      ...
      modal_submit: 'Confirmer la commande ✓',
    ...
    en: {
      ...
      hero_btn1:    'Discover my creations',
      hero_btn2:    'Learn more',
      scroll_lbl:   'Scroll',

      gallery_tag:  'Portfolio',
      gallery_title:'My <span class="highlight-text">Creations</span>',
      gallery_desc: "Joseph's real creations — 100% handmade in Porto-Novo & Calavi, Benin.",
      filter_all:   'All',
      filter_pixel: '🎨 Pixel Macramé',
      filter_bag:   '👜 Bags',
      filter_shoes: '👡 Sandals',
      gallery_cta:  'Order a custom creation',
      cat_pixel:    'Pixel Macramé',
      cat_bag:      'Macramé Bags',
      cat_shoes:    'Macramé Sandals',

      shop_tag:     'Shop',
      shop_title:   'Our <span class="highlight-text">Products</span>',
      shop_desc:    'Order your favourite creations directly — delivery to Porto-Novo and Calavi.',
      btn_order:    'Order',

      stat_years:    'Years of passion',
      stat_creations:'Unique creations',
      stat_handmade: 'Handmade',
      stat_cities:   'Cities in Benin',

      about_tag:    'My Story',
      about_title:  "About<br><span class=\"highlight-text\">Art by Joe</span>",
      ...
      feat1_title:  'Handmade',
      feat1_desc:   'Every piece is unique',
      feat2_title:  'Natural Materials',
      feat2_desc:   'Premium quality threads',
      feat3_title:  'Careful Delivery',
      feat3_desc:   'Porto-Novo & Calavi',

      contact_tag:  'Stay in Touch',
      contact_title:'Let\'s Talk About <span class="highlight-text">Your Project</span>',
      ...
      ph_subject:   'Custom order',
      ph_message:   'Describe your project...',
      btn_send:     'Send message',
      success_title:'Message sent!',
      success_msg:  'Thank you! Joseph will reply very soon.',
      ...
      footer_contact:'Contact',
      svc1: 'Custom orders',
      svc2: 'Macramé sandals',
      svc3: 'Macramé bags',
      svc4: 'Pixel macramé',
      footer_copy:  '© 2025 Art by Joe · All rights reserved · Made with ❤ in Benin 🇧🇯',

      modal_title:  'Place an order',
      modal_lbl_name:  'Your full name *',
      modal_lbl_phone: 'Your phone *',
      modal_lbl_city:  'Your city *',
      modal_lbl_note:  'Note (size, colour…)',
      modal_lbl_momo:  'MoMo number for payment *',
      modal_ph_name:   'E.g. Awa Mensah',
      modal_ph_phone:  'E.g. +229 97 00 00 00',
      modal_ph_city:   'E.g. Porto-Novo',
      modal_ph_note:   'E.g. Size 39, red colour',
      modal_ph_momo:   'Your MTN MoMo number',
    ...
    es: {
      ...
      hero_btn1:    'Descubrir mis creaciones',
      hero_btn2:    'Saber más',
      scroll_lbl:   'Desplazar',

      gallery_tag:  'Portafolio',
      gallery_title:'Mis <span class="highlight-text">Creaciones</span>',
      gallery_desc: 'Las verdaderas creaciones de Joseph — 100% hechas a mano en Porto-Novo & Calavi, Benín.',
      filter_all:   'Todo',
      filter_pixel: '🎨 Pixel Macramé',
      filter_bag:   '👜 Bolsos',
      filter_shoes: '👡 Sandalias',
      gallery_cta:  'Pedir una creación personalizada',
      cat_pixel:    'Pixel Macramé',
      cat_bag:      'Bolsos Macramé',
      cat_shoes:    'Sandalias Macramé',

      shop_tag:     'Tienda',
      shop_title:   'Nuestros <span class="highlight-text">Productos</span>',
      shop_desc:    'Pide directamente tus creaciones favoritas — entrega en Porto-Novo y Calavi.',
      btn_order:    'Pedir',

      stat_years:    'Años de pasión',
      stat_creations:'Creaciones únicas',
      stat_handmade: 'Hecho a mano',
      stat_cities:   'Ciudades en Benín',

      about_tag:    'Mi Historia',
      about_title:  "Acerca de<br><span class=\"highlight-text\">Art by Joe</span>",
      ...
      feat1_title:  'Hecho a Mano',
      feat1_desc:   'Cada pieza es única',
      feat2_title:  'Materiales Naturales',
      feat2_desc:   'Hilos de calidad premium',
      feat3_title:  'Entrega Cuidadosa',
      feat3_desc:   'Porto-Novo & Calavi',

      contact_tag:  'Mantengamos el Contacto',
      contact_title:'Hablemos de <span class="highlight-text">Tu Proyecto</span>',
      contact_desc: "¿Tienes una idea de creación personalizada? No dudes — ¡estoy disponible y soy reactivo!",
      lbl_name:     'Tu nombre *',
      lbl_email:    'Tu correo *',
      lbl_subject:  'Asunto',
      lbl_message:  'Tu mensaje *',
      ph_name:      'Ej: Juan García',
      ph_email:     'tu@ejemplo.com',
      ph_subject:   'Pedido personalizado',
      ph_message:   'Describe tu proyecto...',
      btn_send:     'Enviar mensaje',
      success_title:'¡Mensaje enviado!',
      success_msg:  '¡Gracias! Joseph te responderá muy pronto.',
      ...
      svc1: 'Pedidos personalizados',
      svc2: 'Sandalias macramé',
      svc3: 'Bolsos macramé',
      svc4: 'Pixel macramé',
      footer_copy:  '© 2025 Art by Joe · Todos los derechos reservados · Hecho con ❤ en Benín 🇧🇯',

      modal_title:  'Realizar un pedido',
      modal_lbl_name:  'Tu nombre completo *',
      modal_lbl_phone: 'Tu teléfono *',
      modal_lbl_city:  'Tu ciudad *',
      modal_lbl_note:  'Nota (talla, color…)',
      modal_lbl_momo:  'N° MoMo para el pago *',
      modal_ph_name:   'Ej: Awa Mensah',
      modal_ph_phone:  'Ej: +229 97 00 00 00',
      modal_ph_city:   'Ej: Porto-Novo',
      modal_ph_note:   'Ej: Talla 39, color rojo',
      modal_ph_momo:   'Tu número MTN MoMo',
  ...
  /* ══════════════════════════════════════════════════════════
     2. CONFIG
     ══════════════════════════════════════════════════════════ */
  const MOMO_NUMBER = '+229 01 62 10 86 94'; // ← Remplace par ton vrai numéro MTN MoMo
  const API_URL     = 'http://localhost:3000/api/orders';

  let currentLang = localStorage.getItem('abj_lang') || 'fr';

  /* ══════════════════════════════════════════════════════════
     3. LANGUAGE SWITCHER — injecter dans le header
     ══════════════════════════════════════════════════════════ */
  ...
  function applyLang(lang) {
    ...
    const set = (sel, key, attr = 'innerHTML') => {
      const el = document.querySelector(sel);
      if (el && t[key] !== undefined) el[attr] = t[key];
    };
    const setAll = (sel, key, attr = 'innerHTML') => {
      document.querySelectorAll(sel).forEach(el => { if (t[key] !== undefined) el[attr] = t[key]; });
    };
    const setPh = (sel, key) => {
      const el = document.querySelector(sel);
    ...
    if (gallSection) {
      ...
      const keys = ['filter_all','filter_pixel','filter_bag','filter_shoes'];
      filterBtns.forEach((btn, i) => { if (t[keys[i]]) btn.innerHTML = t[keys[i]]; });

      const catTitles = gallSection.querySelectorAll('.gal-cat-title');
      const catKeys   = ['cat_pixel','cat_bag','cat_shoes'];
      catTitles.forEach((el, i) => { if (t[catKeys[i]]) el.textContent = t[catKeys[i]]; });
    }

    // ── Boutique ──
    const boutSection = document.querySelector('.boutique-section');
    if (boutSection) {
      const tags = boutSection.querySelectorAll('.section-tag');
      if (tags[0]) tags[0].textContent = t.shop_tag;
      ...
      boutSection.querySelectorAll('.prod-hover .btn').forEach(btn => {
        // Garder le prix, juste mettre à jour le label
    ...
    const statKeys   = ['stat_years','stat_creations','stat_handmade','stat_cities'];
    ...
    const featTKeys  = ['feat1_title','feat2_title','feat3_title'];
    const featDKeys  = ['feat1_desc','feat2_desc','feat3_desc'];
    featTitles.forEach((el, i) => { if (t[featTKeys[i]]) el.textContent = t[featTKeys[i]]; });
    featDescs.forEach((el, i)  => { if (t[featDKeys[i]]) el.textContent = t[featDKeys[i]]; });
    ...
    const lKeys  = ['lbl_name','lbl_email','lbl_subject','lbl_message'];
    labels.forEach((el, i) => { if (t[lKeys[i]]) el.textContent = t[lKeys[i]]; });

    setPh('#name',    'ph_name');
    setPh('#email',   'ph_email');
    setPh('#subject', 'ph_subject');
    setPh('#message', 'ph_message');
    ...
    svcLinks.forEach((el, i) => { if (t[svcKeys[i]]) el.textContent = t[svcKeys[i]]; });

    // ── Footer nav ──
    const footerNavLinks = document.querySelectorAll('.footer-column:nth-child(2) .footer-links a');
    const navKeys = ['nav_home','nav_gallery','nav_shop','nav_about','nav_contact'];
    footerNavLinks.forEach((el, i) => { if (t[navKeys[i]]) el.textContent = t[navKeys[i]]; });
  ...
  function updateModalLang() {
    ...
    omMomoSteps.innerHTML = t.modal_momo_steps
      .map(s => `<li>${s.replace('PRICE', currentProduct.price + ' FCFA')}</li>`)
      .join('');
  ...
  omForm.addEventListener('submit', async function (e) {
    ...
    if (!name || !phone || !city || !momo) {
      ...
      [
        { id: 'om-customer-name',  val: name },
        { id: 'om-customer-phone', val: phone },
        { id: 'om-customer-city',  val: city },
        { id: 'om-momo-phone',     val: momo }
      ].forEach(({ id, val }) => {
    ...
    const payload = {
      ...
      product_img:    currentProduct.img || '',
      customer_name:  name,
    ...
    try {
      ...
      if (res.ok) {
        ...
        omSuccessMsg.innerHTML = t.modal_success_msg
          .replace('NAME',  name)
          .replace('PHONE', phone);
      ...
      // Fallback si backend pas encore dispo : succès local
  ...
  /* ══════════════════════════════════════════════════════════
     6. ATTACHER AUX BOUTONS "Commander" DE LA BOUTIQUE
     ══════════════════════════════════════════════════════════ */
    ...
    document.querySelectorAll('.prod-card').forEach(card => {
      ...
      if (btn) {
        btn.addEventListener('click', (e) => {
          e.stopPropagation();
          openOrderModal({
            name:  nameEl  ? nameEl.textContent.trim()  : 'Création',
            price: price,
            img:   imgEl   ? imgEl.src : ''
          });
        });
      ...
      // Aussi sur le bouton dans la section galerie-cta (Commander une création perso)
    });

    // Boutons "Commander" statiques partout
